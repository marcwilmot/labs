...
public class Lab06_PrototypeDestructionNotCalled {
    ...
    public void closingApplicationContext_DoesNotDestroyPrototype() throws SQLException {
        ...
        try{
            ...
            assertEquals(0, RequestHandler.DESTROY_CALLS.get(),
        ...
        assertEquals(0, RequestHandler.DESTROY_CALLS.get(),
                "Context closed, but prototype destroy hook was NOT called (Spring doesn't destroy prototypes).");
